<template>
    ...
    <div class="bg_section  d-flex justify-content-center align-items-center ">
            <div class="container text-white text-center w-50 px-4">
                ...
                <p>Arcu auctor gravida nisl, conque sit nisi tincidunt eget proin. In lacinia lacus donec sed massa in
                    ipsum
                    eros, tristique. Gravida suspendisse etiam in iaculis</p>
                <button class="btn btn-primary  light-grey rounded-pill px-4 bg_white">
                    Buy Avada today
